async def behandel_page(item, page, session):
    ...
    from q_fasit.functionality import launch_fasit
    from q_fasit.functionality import fremsoeg_borger
    from q_fasit.functionality import bo_kommunens_markeringer
